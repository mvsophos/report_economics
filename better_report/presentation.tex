...
\[ V_0=\sum_{t=1}^{\infty}\dfrac{R}{(1+r)^t}=\dfrac{R}{r} \]
Верно только если рента не растёт со временем --- иначе (истощаемый ресурс) рента растёт темпом $r$ по правилу Хотеллинга, и формула не работает.
\end{alertblock}


\iffalse
$R_t$ --- выгода права в момент t. Значит цена права, которое действует $T$ времени:
\[
