...
\vspace{0.3cm}
  \begin{alertblock}{}
    Для VCG характерно то, что участникам выгодно объявлять реальную ценность. Если пытаться завышать ценность, то вы будете систематически проигрывать.
  \end{alertblock}
...
Доход $R$ через $t$ лет сегодня стоит меньше:
\[ PV=\dfrac{R}{(1+r)^t} \]
\end{block}
